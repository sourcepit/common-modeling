...
public class EStringMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String, String>
{
   ...
   {
      return CommonModelPackage.Literals.ESTRING_MAP_ENTRY;
   }
   ...
   public void setTypedKey(String newKey)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, CommonModelPackage.ESTRING_MAP_ENTRY__KEY, oldKey, key));
   }
